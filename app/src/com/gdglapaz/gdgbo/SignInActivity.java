...
import com.gdglapaz.gdgbo.PlusClientFragment.OnSignedInListener;
...
public class SignInActivity extends FragmentActivity
    ...
    //BASE DE DATOS
//g    private PomodoroDatabaseAdapter db;
    @Override
   ...
   //g     db = new PomodoroDatabaseAdapter(this);
    ...
    public void onSignedIn(PlusClient plusClient) {
        ...
        if (currentPerson != null) {
          ...
          //g         db.insertPlus(currentPerson.getDisplayName());

          //g            Cursor cursor_show = db.getAllPomodoros();
          //g            if (cursor_show.moveToLast()) {				
          //gString name = cursor_show.getString(1);
            	
          //gToast.makeText(SignInActivity.this, " "+name, Toast.LENGTH_SHORT).show();
          //g}
